...
import org.springframework.cloud.netflix.metrics.servo.EnableServo;
...
@ContextConfiguration(classes = { MetricsRestTemplateRestTemplateConfig.class, MetricsRestTemplateTestConfig.class })
@TestPropertySource(properties = { "netflix.metrics.restClient.metricName=metricName", "spring.aop.proxy-target-class=true" })
public class MetricsClientHttpRequestInterceptorTests extends AbstractMetricsTests {
	...
	public void metricsGatheredWhenSuccessful() {
        ...
        BasicTimer timer = ServoMonitorCache.getTimer("metricName", "method", "GET", "uri", "_test_-id-", "status", "200", "clientName",
                "none");
