...
class RetryRibbonConfiguration {
	...
	class CustomRetryHandler extends DefaultLoadBalancerRetryHandler {
	    ...
	    private List<Class<? extends Throwable>> retriable = 
	            Lists.<Class<? extends Throwable>>newArrayList(UnknownHostException.class, ConnectException.class, SocketTimeoutException.class);
	    
	    @SuppressWarnings("unchecked")
	    private List<Class<? extends Throwable>> circuitRelated = 
	            Lists.<Class<? extends Throwable>>newArrayList(UnknownHostException.class, SocketException.class, SocketTimeoutException.class);
