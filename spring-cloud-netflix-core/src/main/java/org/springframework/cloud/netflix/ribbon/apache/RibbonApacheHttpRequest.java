...
public class RibbonApacheHttpRequest extends ClientRequest implements Cloneable {
	...
	public RibbonApacheHttpRequest(final String method, final URI uri, final Boolean retryable,
	...
	public RibbonApacheHttpRequest withNewUri(final URI uri) {
		return new RibbonApacheHttpRequest(this.method, uri, this.isRetriable, this.headers, this.params,
			this.requestEntity);
	}
