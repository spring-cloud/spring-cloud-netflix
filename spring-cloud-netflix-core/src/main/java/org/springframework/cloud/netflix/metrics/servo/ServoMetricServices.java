...
/**
 * Provides a <code>CounterService</code> and <code>GaugeService</code> implementation backed by Servo.
 *
...
public class ServoMetricServices implements CounterService, GaugeService {
	...
	private void incrementInternal(String name, long value) {
		...
		if (name.startsWith("status.")) {
			// drop this metric since we are capturing it already with ServoHandlerInterceptor,
	...
	public void reset(String name) {
        ...
        BasicDistributionSummary distributionSummary = distributionSummaries.remove(strippedName);
	...
	public void submit(String name, double dValue) {
        ...
        if (name.startsWith("histogram.")) {
            BasicDistributionSummary distributionSummary = distributionSummaries.get(strippedName);
            if(distributionSummary == null) {
                distributionSummary = new BasicDistributionSummary(MonitorConfig.builder(strippedName).build());
