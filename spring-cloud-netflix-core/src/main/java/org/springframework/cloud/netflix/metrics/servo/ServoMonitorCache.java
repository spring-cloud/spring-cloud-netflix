...
public class ServoMonitorCache {
     ...
     * @return an already registered timer if it exists, otherwise create/register one and return it.
     */
    ...
    public static BasicTimer getTimer(String name, String... tags) {
    ...
    public static void unregisterAll() {
        for (BasicTimer t : timerCache.values()) {
            DefaultMonitorRegistry.getInstance().unregister(t);
        }
        timerCache.clear();
    }
}
