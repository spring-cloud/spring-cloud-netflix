...
`RestTemplate`, Ribbon, or Feign.  No matter how you choose to make HTTP requests, there is always
...
retry any failed requests (assuming your configuration allows it to).
