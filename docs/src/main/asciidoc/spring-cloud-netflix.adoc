...
WARNING: defaultZone property doesn't work without camel case because "serviceUrl" property is a Map<String, String>. This means that there is no information available to know that default-url should be defaultUrl.
