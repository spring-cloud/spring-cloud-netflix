...
The request compression gives you similar setting as you may set for your web server:
...
Allowing to be selective about the compressed media types and minimum request threshold length.
