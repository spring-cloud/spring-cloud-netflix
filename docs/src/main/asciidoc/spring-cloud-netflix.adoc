...
and artifact id `spring-cloud-starter-netflix-eureka-client`. See the https://projects.spring.io/spring-cloud/[Spring Cloud Project page]
...
and artifact id `spring-cloud-starter-netflix-eureka-server`. See the https://projects.spring.io/spring-cloud/[Spring Cloud Project page]
for details on setting up your build system with the current Spring Cloud Release Train.
...
and artifact id `spring-cloud-starter-netflix-hystrix`. See the https://projects.spring.io/spring-cloud/[Spring Cloud Project page]
for details on setting up your build system with the current Spring Cloud Release Train.
...
and artifact id `spring-cloud-starter-hystrix-netflix-dashboard`. See the https://projects.spring.io/spring-cloud/[Spring Cloud Project page]
for details on setting up your build system with the current Spring Cloud Release Train.
...
and artifact id `spring-cloud-starter-netflix-ribbon`. See the https://projects.spring.io/spring-cloud/[Spring Cloud Project page]
for details on setting up your build system with the current Spring Cloud Release Train.
...
and artifact id `spring-cloud-starter-netflix-zuul`. See the https://projects.spring.io/spring-cloud/[Spring Cloud Project page]
for details on setting up your build system with the current Spring Cloud Release Train.
